            ...
            <section class="flex-container">
            	<div class="column2_1">
					...
					<?php 
                        ...
                        echo "Event:&emsp;&emsp;" . $event_name . "<br><br>";

                        if ($attendees_under5 != 0){
                            echo "Number of attendees under 5 years:&emsp;&emsp;" . $attendees_under5 . "<br><br>";
                        }

                        if ($attendees_5_12 != 0){
                            echo "Number of attendees 5 to 12 years:&emsp;&emsp;" . $attendees_5_12 . "<br><br>";
                        }

                        if ($attendees_13_17 != 0){
                            echo "Number of attendees 13 to 17 years:&emsp;&emsp;" . $attendees_13_17 . "<br><br>";
                        }

                        if ($attendees_over18 != 0){
                            echo "Number of attendees over 18 years:&emsp;&emsp;" . $attendees_over18 . "<br><br>";
                        }
                        
                        echo "Total Number of Attendees:&emsp;&emsp;&emsp;&emsp;" . $total_attendees . "<br><br><br><br>";
                    ...
                    <button onclick="window.location.href = 'https://edoras.sdsu.edu/~cssc0220/events_registration.php';">Try Again</button>
